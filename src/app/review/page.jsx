...
import { useUserDetails } from "@/utils/getUserDetails"; // Import the new hook
...
const ReviewsPage = () => {
  ...
  const { user, loading: userLoading } = useUserDetails(); // Use the new hook
  ...
  return (
    <div className="roboto-en">
        ...
        <div className="max-w-4xl mx-auto px-4 py-10">
            <h1 className="text-2xl font-bold mb-6 text-center">All Reviews</h1>
            ...
            {loading ? (
                ...
                {reviews.map((review) => (
                    ...
                    {/* Admin Delete - Show only if user exists */}
                    {user && (
                        <button
